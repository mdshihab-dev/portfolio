...
const Card = ({imageUrl,message,name,companyName}) => {
  return (
    <div>
        <div className={` scale-x-95 lg:scale-x-100 w-screen lg:w-[380px] group h-[430px] p-12 box-border pb flex flex-col items-center bg-light-main shadow-md  rounded-xl backdrop-blur-xl dark:border-2 dark:border-[rgba(238,234,234,0.2)] dark:bg-[rgba(255,255,255,0.1)] dark:backdrop-blur-sm  dark:hover:border-violet-700 transition-all duration-500 dark:hover:shadow dark:hover:shadow-violet-700 `}>
