...
const ProjectPrototype = ({imageUrl,title,desc}) => {
  return (
    <div className=' scale-x-95 lg:scale-x-100 my-2.5 lg:my-0 w-screen lg:w-[49%] shadow-md h-auto lg:my-[13px] group box-border p-4 lg:p-6 backdrop-blur-xl dark:border dark:border-[rgba(238,234,234,0.2)] dark:bg-[rgba(255,255,255,0.03)] dark:backdrop-blur-sm rounded-xl dark:hover:border-violet-700 transition-all duration-500 dark:hover:shadow dark:hover:shadow-violet-700'>
